...
#include "asm/jz_mem_nand_configs/MDDR_MT46H128M16LF.h"
...
//#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=128M@0x30000000 console=ttyS1,57600n8 ip=off root=/dev/ram0 rw rdinit=/init memcfg=pt701-8"
#define CONFIG_BOOTARGS		"mem=192M0x0 mem=256M@0x30000000 console=ttyS1,57600n8 ip=off root=/dev/ram0 rw rdinit=/init"
