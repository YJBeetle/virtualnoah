...
#define CONFIG_JZ4750L		1  /* Jz4750 SoC */
#define CONFIG_FPGA		1  /* f4750l is an FPGA board */
#define CONFIG_F4750L		1  /* f4750l validation board */
...
#define CONFIG_BOOTFILE	        "lhhuang/f4750l/uImage"	/* file to load */
#define CONFIG_BOOTARGS		"mem=32M console=ttyS0,9600n8 ip=dhcp nfsroot=192.168.1.4:/nfsroot/user/lhhuang/root26 rw ethaddr=00:2a:c6:2c:ae:34"
...
#define	CFG_PROMPT		"F4750L # "	/* Monitor Command Prompt    */
