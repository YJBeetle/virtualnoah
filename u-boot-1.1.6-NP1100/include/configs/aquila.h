...
#define CONFIG_AQUILA		1  /* AQUILA validation board */
...
#define CONFIG_BOOTARGS		"mem=128M console=ttyS1,115200n8 ip=off root=/dev/ram0 rw rdinit=/init"
...
#define	CFG_PROMPT		"AQUILA # "	/* Monitor Command Prompt    */
...
#define GPIO_IOSWITCH_EN    (32*5+23) /* GPF23 */
#define GPIO_BOOT_SEL0      (32*2+30) /* GPC30 */
#endif	/* __CONFIG_H */
