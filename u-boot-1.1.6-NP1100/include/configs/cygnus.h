...
/*
 * This file contains the configuration parameters for the cygnus board.
 */
...
#define CONFIG_CYGNUS		1  /* cygnus validation board */
...
#define CFG_CPU_SPEED		(432 * 1000000)	/* CPU clock */
...
#define CONFIG_BOOTARGS		"mem=64M console=ttyS1,57600n8 ip=192.168.2.128:192.168.3.56:192.168.1.1:255.255.248.0 nfsroot=192.168.3.56:/nfsroot/root26 rw"
#define CONFIG_BOOTCOMMAND	"tftp;bootm"
#define CFG_AUTOLOAD		"n"		/* No autoload */

#define CONFIG_NET_MULTI
#define CONFIG_ETHADDR		00:2a:c6:7a:cd:fc    /* Ethernet address */
...
#define	CFG_PROMPT		"CYGNUS # "	/* Monitor Command Prompt    */
