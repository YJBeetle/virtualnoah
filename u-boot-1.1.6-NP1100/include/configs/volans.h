...
/*
 * This file contains the configuration parameters for the volans board.
 */
...
#define CONFIG_VOLANS		1  /* volans dev board */
...
#define	CFG_PROMPT		"VOLANS # "	/* Monitor Command Prompt    */
