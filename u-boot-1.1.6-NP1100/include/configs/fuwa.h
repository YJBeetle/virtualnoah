...
#define CFG_EXTAL		33000000	/* EXTAL freq: 12 MHz */
...
#define CONFIG_BOOTFILE	        "lhhuang/fuwa/uImage"	/* file to load */
#define CONFIG_BOOTARGS		"mem=64M console=ttyS1,9600n8 ip=dhcp nfsroot=192.168.1.4:/nfsroot/user/lhhuang/root26 rw ethaddr=00:2a:c6:2c:ad:fd"
#define CONFIG_BOOTCOMMAND	"bootp;setenv serverip 192.168.1.4;tftp;bootm"
#define CFG_AUTOLOAD		"n"		/* No autoload */

#define CONFIG_NET_MULTI
#define CONFIG_ETHADDR		00:2a:c6:2c:ad:fd    /* Ethernet address */
