...
#define CONFIG_JZ4810		1  /* Jz4810 SoC */
#define CONFIG_FPGA		1  /* f4810 is an FPGA board */
#define CONFIG_F4810		1  /* f4810 validation board */
...
#define CONFIG_BOOTARGS		"mem=128M console=ttyS3,9600n8 ip=dhcp nfsroot=192.168.3.56:/nfsroot/root26 rw"
#else
#define CONFIG_BOOTARGS		"mem=256M console=ttyS3,9600n8 ip=dhcp nfsroot=192.168.3.56:/nfsroot/root26 rw"
#endif
...
#define	CFG_PROMPT		"F4810 # "	/* Monitor Command Prompt    */
