...
struct mtd_partition partition_info[] = {
	{name:"U_boot partition",
	 offset:	0x00000000,
	 size:		0x00200000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"Serial partition",
	 offset:	0x00200000,
	 size:		0x00200000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"Kernel partition",
	 ...
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"ROOT_FS partition",
	 offset:	0x00600000,
	 size:		0x01800000-0x00600000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"Settings partition",
	 offset:	0x01800000,
	 size:		0x02300000-0x01800000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"Program_FS partition",
	 offset:	0x02300000,
	 size:		0x0cd00000-0x02300000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"Data_FS partition",
	 offset:	0x0cd00000,
	 size:		0x15900000-0x0cd00000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"User_FS partition",
	 offset:	0x15900000,
	 size:		0x16500000-0x15900000,
	 use_planes: 0,
	 mtdblock_jz_invalid: 1},
	{name:"User_Disk partition",
	 offset:	0x16500000,
